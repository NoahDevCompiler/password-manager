...
<template>
  <div class="master relative">
    ...
    <div class="flex flex-col items-center justify-center lg:py-0">
      ...
      <div
        class="bg-white rounded-lg xl:px-7 dark:bg-[#4A4A4A] dark:border-gray-700 w-96"
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1
            class="text-xl font-bold leading-tight tracking-tight flex justify-center items-center text-gray-900 md:text-2xl dark:text-white"
          >
            Account Erstellen
          </h1>
          <form
            class="space-y-4 md:space-y-6"
            @submit.prevent="confirmValidation"
          >
            <div>
              <label
                for="email"
