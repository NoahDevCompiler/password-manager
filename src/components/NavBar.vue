    ...
    <nav class="mx-auto flex w-full items-center justify-between p-6 lg:px-8 " aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">Passwort Manager</span>
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="#" class="text-[#E0D8DE] hover:text-[#949D6A] font-semibold">Features</a>
        <a href="#" class="text-[#E0D8DE] hover:text-[#949D6A] font-semibold">Marketplace</a>
        <a href="#" class="text-[#E0D8DE] hover:text-[#949D6A] font-semibold">Company</a>
      </PopoverGroup>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="#" class="text-sm/6 font-semibold text-[#E0D8DE]">Log in <span aria-hidden="true">&rarr;</span></a>
      </div>
    </nav>
    <Dialog class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
      ...
      <DialogPanel class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        <div class="flex items-center justify-between">
          ...
          <button type="button" class="-m-2.5 rounded-md p-2.5 text-[#949D6A]" @click="mobileMenuOpen = false">
          ...
          <div class="-my-6 divide-y ">
            <div class="space-y-2 py-6">
              <Disclosure as="div" class="-mx-3" v-slot="{ open }">
                <DisclosureButton class="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base/7 font-semibold text-[#E0D8DE] hover:[#949D6A]">
                  Product
                  <ChevronDownIcon :class="[open ? 'rotate-180' : '', 'size-5 flex-none']" aria-hidden="true" />
                </DisclosureButton>
                <DisclosurePanel class="mt-2 space-y-2">
                  <DisclosureButton v-for="item in [...products, ...callsToAction]" :key="item.name" as="a" :href="item.href" class="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-[#ffffff] hover:text-[#949D6A]">{{ item.name }}</DisclosureButton>
                </DisclosurePanel>
              </Disclosure>
              
            </div>
            <div class="py-6">
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-[#E0D8DE] hover:bg-gray-50">Log in</a>
            </div>
          </div>
        </div>
      </DialogPanel>
